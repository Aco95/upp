...
public class SendSuccessEmail implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
    	...
    	String mailSubject = "Succesfully submited paper notification email";
    	String mailText = "Dear Sir/Madam, Congratulations, your scientific paper has been published sucesfully!";
